# V334-A11B Refined Analyzer Visible Risk Locator

Purpose: ignore safe bilingual helper fallbacks and report only likely raw visible Korean risks after A11B.

## Summary

| metric | value |
|---|---:|
| total pattern hits | 310 |
| risky hits | 229 |
