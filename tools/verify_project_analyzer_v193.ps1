param(
  [string]$Version = "20260606_v193_a1",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v193_a1.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V193</span>' "BADGE_V193"
...
Write-Host ""
Write-Host "V193_PROJECT_ANALYZER_VERIFY_OK"
