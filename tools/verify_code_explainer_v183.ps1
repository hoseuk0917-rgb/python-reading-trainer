param(
  [string]$Version = "20260606_v183_a1",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v183_a1.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V183</span>' "BADGE_V183"
...
Assert-Contains ".\src\pwa\code_explainer_rules.js" "CONFIG_META_GUARD_V183_A1" "CONFIG_META_GUARD"
Assert-Contains ".\src\pwa\code_explainer_rules.js" "YAML_TAG_GUARD_V183_A1" "YAML_TAG_GUARD"
...
Write-Host ""
Write-Host "V183_CODE_EXPLAINER_VERIFY_OK"
