param(
  [string]$Version = "20260606_v175_a1",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v175.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V175</span>' "BADGE_V175"
...
Write-Host ""
Write-Host "V175_CODE_EXPLAINER_VERIFY_OK"
