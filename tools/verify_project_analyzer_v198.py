...
def main():
    ...
    parser.add_argument("--version", default="20260608_v198_a1")
    parser.add_argument("--port", type=int, default=5173)
    parser.add_argument("--report", default=".tmp/code_explainer_smoke_report_v198_a1.json")
    ...
    assert_contains("src/pwa/index.html", 'id="codeExplainerVersion" class="badge">V198</span>', "BADGE_V198")
    ...
    assert_contains("src/pwa/project_analyzer.js", "PROJECT_ANALYZER_CLEANUP_V198_A1", "PROJECT_CLEANUP_V198")
    assert_contains("src/pwa/project_analyzer.js", "PROJECT_PROBE_V198_OK", "PROJECT_PROBE_OK_V198")
    assert_contains("src/pwa/project_analyzer.js", "project_probe_v198.json", "PROJECT_PROBE_JSON_V198")
    assert_contains("src/pwa/project_analyzer.js", "# Project Probe V198", "PROJECT_PROBE_MD_V198")
    ...
    assert_contains("src/pwa/project_analyzer.js", "PROJECT_ANALYZER_UX_V198_A1", "PROJECT_UX_V198_MARKER")
    ...
    assert_contains("src/pwa/style.css", "PROJECT ANALYZER UX V198-A1 START", "PROJECT_UX_CSS")

    assert_contains("src/pwa/style.css", "PROJECT ANALYZER V198-A1 START", "PROJECT_ANALYZER_CSS")
    assert_contains("src/pwa/style.css", "PROJECT ANALYZER ENV V198-A1 START", "PROJECT_ENV_CSS")
    assert_contains("src/pwa/style.css", "PROJECT ANALYZER JSON REPORT V198-A1 START", "PROJECT_JSON_CSS")
    ...
    print()
    print("V198_PROJECT_ANALYZER_VERIFY_OK")
