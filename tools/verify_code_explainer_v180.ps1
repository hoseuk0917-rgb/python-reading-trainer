param(
  [string]$Version = "20260606_v180_a4",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v180.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V180</span>' "BADGE_V180"
...
Write-Host ""
Write-Host "V180_CODE_EXPLAINER_VERIFY_OK"
