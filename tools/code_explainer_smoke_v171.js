...
python tools/validate_lessons.py --expected-app-version 20260606_v196_a1 --expected-lesson-cards 1785
Write-Host "DONE"`,
...
npm install
npm run build
python tools/validate_lessons.py --expected-app-version 20260606_v196_a1
git status --short`,
...
,
  {
    name: "python_mermaid_producer_consumer_edges_v211",
    requestedLanguage: "python",
    expectedLanguage: "python",
    minSteps: 4,
    code: `raw = " A "
