param(
  [string]$Version = "20260606_v188_a2",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v188_a2.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V188</span>' "BADGE_V188"
...
Write-Host ""
Write-Host "V188_CODE_EXPLAINER_VERIFY_OK"
