param(
  [string]$Version = "20260606_v177_a1",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v177.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V177</span>' "BADGE_V177"
...
Write-Host ""
Write-Host "V177_CODE_EXPLAINER_VERIFY_OK"
