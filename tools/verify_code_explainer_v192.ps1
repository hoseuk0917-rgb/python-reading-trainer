param(
  [string]$Version = "20260606_v192_a1",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v192_a1.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V192</span>' "BADGE_V192"
...
Write-Host ""
Write-Host "V192_CODE_EXPLAINER_VERIFY_OK"
