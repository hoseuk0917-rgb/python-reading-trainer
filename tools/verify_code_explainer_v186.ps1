param(
  [string]$Version = "20260606_v186_a3",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v186_a3.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V186</span>' "BADGE_V186"
...
Assert-Contains ".\src\pwa\code_explainer.js" '[긴 코드 구조 요약]' "TEXT_REPORT_LONG_OVERVIEW"
...
Write-Host ""
Write-Host "V186_CODE_EXPLAINER_VERIFY_OK"
