...
def main():
    ...
    parser.add_argument("--version", default="20260608_v197_a1")
    parser.add_argument("--port", type=int, default=5173)
    parser.add_argument("--report", default=".tmp/code_explainer_smoke_report_v197_a1.json")
    ...
    assert_contains("src/pwa/index.html", 'id="codeExplainerVersion" class="badge">V197</span>', "BADGE_V197")
    ...
    assert_contains("src/pwa/project_analyzer.js", "PROJECT_ANALYZER_CLEANUP_V197_A1", "PROJECT_CLEANUP_V197")
    assert_contains("src/pwa/project_analyzer.js", "PROJECT_PROBE_V197_OK", "PROJECT_PROBE_OK_V197")
    assert_contains("src/pwa/project_analyzer.js", "project_probe_v197.json", "PROJECT_PROBE_JSON_V197")
    assert_contains("src/pwa/project_analyzer.js", "# Project Probe V197", "PROJECT_PROBE_MD_V197")
    ...
    assert_contains("src/pwa/style.css", "PROJECT ANALYZER V197-A1 START", "PROJECT_ANALYZER_CSS")
    assert_contains("src/pwa/style.css", "PROJECT ANALYZER ENV V197-A1 START", "PROJECT_ENV_CSS")
    assert_contains("src/pwa/style.css", "PROJECT ANALYZER JSON REPORT V197-A1 START", "PROJECT_JSON_CSS")
    ...
    print()
    print("V197_PROJECT_ANALYZER_VERIFY_OK")
