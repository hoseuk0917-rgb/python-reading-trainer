...
ok = pass("developer_no_body_observer", !remoteEntry.includes("new MutationObserver") && !remoteEntry.includes("setInterval")) && ok;
...
ok = pass("developer_exit_fix_present", exitFix.includes("PRTDeveloperExitMobileFixV40063")) && ok;
