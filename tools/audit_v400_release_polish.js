...
let ok = true;
ok = pass("root_release_v400_6", rootIndex.includes('RELEASE = "20260821_v400_6"')) && ok;
...
ok = pass("manifest_v400_6", manifest.start_url === "./?release=20260821_v400_6") && ok;
ok = pass("manifest_maskable", manifest.icons.some((row) => row.purpose === "maskable")) && ok;
...
ok = pass("sw_v400_6", sw.includes("python-reading-trainer-v400-6-brand1-20260821")) && ok;
