param(
  [string]$Version = "20260606_v181_a3",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v181_a3.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V181</span>' "BADGE_V181"
...
Write-Host ""
Write-Host "V181_CODE_EXPLAINER_VERIFY_OK"
