param(
  [string]$Version = "20260606_v194_a1",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v194_a1.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V194</span>' "BADGE_V194"
...
Write-Host ""
Write-Host "V194_PROJECT_ANALYZER_VERIFY_OK"
