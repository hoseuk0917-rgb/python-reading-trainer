param(
  [string]$Version = "20260606_v179_a1",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v179.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V179</span>' "BADGE_V179"
...
Write-Host ""
Write-Host "V179_CODE_EXPLAINER_VERIFY_OK"
