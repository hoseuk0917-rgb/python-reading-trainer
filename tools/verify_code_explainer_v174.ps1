param(
  [string]$Version = "20260606_v174_a1",
  [int]$Port = 5173,
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V174</span>' "BADGE_V174"
...
Write-Host ""
Write-Host "V174_CODE_EXPLAINER_VERIFY_OK"
