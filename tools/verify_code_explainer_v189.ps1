param(
  [string]$Version = "20260606_v189_a2",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v189_a2.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V189</span>' "BADGE_V189"
...
Write-Host ""
Write-Host "V189_CODE_EXPLAINER_VERIFY_OK"
