param(
  [string]$Version = "20260606_v187_a2",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v187_a2.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V187</span>' "BADGE_V187"
...
Write-Host ""
Write-Host "V187_CODE_EXPLAINER_VERIFY_OK"
