param(
  [string]$Version = "20260606_v176_a4",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v176.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V176</span>' "BADGE_V176"
...
Write-Host ""
Write-Host "V176_CODE_EXPLAINER_VERIFY_OK"
