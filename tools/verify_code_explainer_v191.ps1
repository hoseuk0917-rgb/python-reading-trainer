param(
  [string]$Version = "20260606_v191_a1",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v191_a1.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V191</span>' "BADGE_V191"
...
Write-Host ""
Write-Host "V191_CODE_EXPLAINER_VERIFY_OK"
