...
def main():
    ...
    parser.add_argument("--version", default="20260606_v196_a1")
    parser.add_argument("--port", type=int, default=5173)
    parser.add_argument("--report", default=".tmp/code_explainer_smoke_report_v196_a1.json")
    ...
    assert_contains("src/pwa/index.html", 'id="codeExplainerVersion" class="badge">V196</span>', "BADGE_V196")
    ...
    assert_contains("src/pwa/project_analyzer.js", "PROJECT_ANALYZER_CLEANUP_V196_A1", "PROJECT_CLEANUP_V196")
    assert_contains("src/pwa/project_analyzer.js", "PROJECT_PROBE_V196_OK", "PROJECT_PROBE_OK_V196")
    assert_contains("src/pwa/project_analyzer.js", "project_probe_v196.json", "PROJECT_PROBE_JSON_V196")
    assert_contains("src/pwa/project_analyzer.js", "# Project Probe V196", "PROJECT_PROBE_MD_V196")
    ...
    assert_contains("src/pwa/style.css", "PROJECT ANALYZER V196-A1 START", "PROJECT_ANALYZER_CSS")
    assert_contains("src/pwa/style.css", "PROJECT ANALYZER ENV V196-A1 START", "PROJECT_ENV_CSS")
    assert_contains("src/pwa/style.css", "PROJECT ANALYZER JSON REPORT V196-A1 START", "PROJECT_JSON_CSS")
    ...
    print()
    print("V196_PROJECT_ANALYZER_VERIFY_OK")
