param(
  [string]$Version = "20260606_v182_a2",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v182_a2.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V182</span>' "BADGE_V182"
...
Assert-Contains ".\src\pwa\code_explainer_rules.js" "CONFIG_META_GUARD_V182_A2" "CONFIG_META_GUARD"
...
Write-Host ""
Write-Host "V182_CODE_EXPLAINER_VERIFY_OK"
