...
SCRIPT = '  <script src="./learning_flow_hardening_v347.js?v=20260812_v347_a11"></script>'
OLD_SCRIPTS = [
    ...
    '  <script src="./learning_flow_hardening_v347.js?v=20260812_v347_a9"></script>',
    '  <script src="./learning_flow_hardening_v347.js?v=20260812_v347_a10"></script>',
]
