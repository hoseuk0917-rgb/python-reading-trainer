...
const OUT_MD = path.join(ROOT, "docs/quality/real_world_code_sample_audit_v330_a1.md");
const OUT_JSON = path.join(ROOT, "docs/quality/real_world_code_sample_audit_v330_a1.json");
...
function main() {
  ...
  console.log("V330_A1_REAL_WORLD_CODE_SAMPLE_AUDIT");
