...
const cssText = fs.readFileSync(path.join(root, "src/pwa/worked_example_quality_v355.css"), "utf8");
...
check("R2_TAKES_UI_OWNERSHIP", r2Text.includes("takeUiOwnership") && r2Text.includes("__workedExampleQualityV355Observer") && r2Text.includes("legacyObserver.disconnect()"));
check("R2_ISOLATED_OWNED_SURFACE", r2Text.includes('box.id = "workedExampleV355"') && r2Text.includes("ensureOwnedBox") && r2Text.includes("suppressLegacyBox"));
...
check("R2_EFFECTIVE_CORPUS_AUDIT", r2Text.includes("auditEffectiveCorpus") && r2Text.includes("missing: []") && r2Text.includes("duplicate: []"));
check("R2_BOUNDED_RECONCILIATION", r2Text.includes("scheduleBoundedRefresh") && r2Text.includes("[0, 40, 120, 300]"));
check("ISOLATED_SURFACE_STYLED", cssText.includes("#workedExampleV355") && cssText.includes("#workedExampleV355.hidden"));
check("LEGACY_SURFACE_VISUALLY_SUPPRESSED", cssText.includes('data-worked-example-ui-owner-v355="v355_r2"') && cssText.includes("#workedExampleV340"));
