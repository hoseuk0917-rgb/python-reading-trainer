param(
  [string]$Version = "20260606_v185_a2",
  [int]$Port = 5173,
  [string]$ReportPath = ".tmp\code_explainer_smoke_report_v185_a2.json",
...
Assert-Contains ".\src\pwa\index.html" 'id="codeExplainerVersion" class="badge">V185</span>' "BADGE_V185"
...
Write-Host ""
Write-Host "V185_CODE_EXPLAINER_VERIFY_OK"
